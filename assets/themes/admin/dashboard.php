...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="headInfo" style="width: 15%; height:70px;background-color: #66b3ff;margin-bottom: 40px;margin-left: 20px; float:left; text-align: center;padding-top:5px;color:white;font-size: 50px;font-family: 'Yu Gothic Light'">
